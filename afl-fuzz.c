...
#ifdef _WIN64
  dll_init_ptr = (dll_init)GetProcAddress(hLib, "_dll_init");
#else
...
#ifdef _WIN64
  dll_run_ptr = (dll_run)GetProcAddress(hLib, "_dll_run");
#else
...
#ifdef _WIN64
  dll_run_target_ptr = (dll_run_target)GetProcAddress(hLib, "_dll_run_target");
#else
